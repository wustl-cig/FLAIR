...
from guided_diffusion.facelib.detection.align_trans import (
    get_reference_facial_points,
    warp_and_crop_face,
)
from guided_diffusion.facelib.detection.retinaface.retinaface_net import (
    FPN,
    SSH,
    MobileNetV1,
    make_bbox_head,
...
from guided_diffusion.facelib.detection.retinaface.retinaface_utils import (
    PriorBox,
    batched_decode,
...
class RetinaFace(nn.Module):
    def __init__(self, network_name="resnet50", half=False, phase="test", device="cpu"):
